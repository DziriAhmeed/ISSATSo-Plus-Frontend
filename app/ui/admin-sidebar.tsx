  ...
  return (
    <>
      ...
      <aside
        ...
        id="nav-menu-4"
        aria-label="Side navigation"
        className={`fixed top-0 bottom-0 left-0 z-40 flex w-52 flex-col bg-[#516DFF] h-screen rounded-lg transition-transform lg:translate-x-0 ${
          isSideNavOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="flex flex-col items-center gap-4  p-6">
          <div className="shrink-0 text-sm text-white">ISSATO PLUS+</div>
        </div>
        <nav aria-label="side navigation" className="flex-1  overflow-auto">
          <div>
            <ul className="flex flex-1 flex-col gap-1 ">
              ...
              <li className="px-3">
                <Link
                  href="/dashboard/adminstudentlist"
                  className="flex items-center gap-3 rounded p-3 text-white transition-colors hover:bg-emerald-50 hover:text-emerald-500 focus:bg-emerald-50 aria-[current=page]:bg-emerald-50 aria-[current=page]:text-emerald-500 "
                >
                  <div className="flex items-center self-center ">
                    <svg
          ...
          <div>
            <ul className="flex flex-1 flex-col gap-1 3">
              <li className="px-3">
                <Link
              ...
              <li className="px-3">
                <Link
                  href="/dashboard/issatsoavailability"
                  className="flex items-center gap-3 rounded p-3 text-white transition-colors hover:bg-emerald-50 hover:text-emerald-500 focus:bg-emerald-50 aria-[current=page]:bg-emerald-50 aria-[current=page]:text-emerald-500 "
                >
                  <div className="flex items-center self-center ">
                    <svg
